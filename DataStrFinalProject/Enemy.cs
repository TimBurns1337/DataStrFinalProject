namespace DataStrFinalProject
{
    internal class Enemy : IEnemyModel
    {
        ...
        public int Strength { get => EnemyModel.Strength * STRBuff; set => EnemyModel.Strength = value; }
        public int Speed { get => EnemyModel.Speed * SPDBuff; set => EnemyModel.Speed = value; }
        public int Health { get => EnemyModel.Health * HTHBuff; set => EnemyModel.Health = value; }
